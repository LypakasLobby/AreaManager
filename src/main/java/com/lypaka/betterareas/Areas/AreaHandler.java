package com.lypaka.betterareas.Areas;

import com.google.common.reflect.TypeToken;
import com.lypaka.betterareas.Areas.SpawnerSettings.FishSpawnerSettings;
import com.lypaka.betterareas.Areas.SpawnerSettings.HeadbuttSpawnerSettings;
import com.lypaka.betterareas.Areas.SpawnerSettings.NaturalSpawnerSettings;
import com.lypaka.betterareas.Areas.SpawnerSettings.RockSmashSpawnerSettings;
...
public class AreaHandler {
    ...
    public static void loadAreas() throws IOException, ObjectMappingException {
        ...
        for (String area : ConfigGetters.areaNames) {
            ...
            Path dir = ConfigUtils.checkDir(Paths.get("./config/betterareas/areas/" + area));
            BasicConfigManager bcm = new BasicConfigManager(files, dir, BetterAreas.class, BetterAreas.MOD_NAME, BetterAreas.MOD_ID, BetterAreas.logger);
            bcm.init();
            ...
            BetterAreas.areaConfigManager.put(area, bcm);

            List<String> fishSpawns = bcm.getConfigNode(0, "Fish-Spawns").getList(TypeToken.of(String.class));
            ComplexConfigManager fcm = new ComplexConfigManager(fishSpawns, "fish-spawns", "fishSpawnTemplate.conf", dir, BetterAreas.class, BetterAreas.MOD_NAME, BetterAreas.MOD_ID, BetterAreas.logger);
            fcm.init();
            ...
            ComplexConfigManager hcm = new ComplexConfigManager(headbuttSpawns, "headbutt-spawns", "headbuttSpawnTemplate.conf", dir, BetterAreas.class, BetterAreas.MOD_NAME, BetterAreas.MOD_ID, BetterAreas.logger);
            hcm.init();
            ...
            ComplexConfigManager ncm = new ComplexConfigManager(naturalSpawns, "natural-spawns", "naturalSpawnTemplate.conf", dir, BetterAreas.class, BetterAreas.MOD_NAME, BetterAreas.MOD_ID, BetterAreas.logger);
            ncm.init();
            ...
            ComplexConfigManager rcm = new ComplexConfigManager(rockSmashSpawns, "rock-smash-spawns", "rockSmashTemplate.conf", dir, BetterAreas.class, BetterAreas.MOD_NAME, BetterAreas.MOD_ID, BetterAreas.logger);
            rcm.init();
