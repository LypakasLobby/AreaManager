...
import com.lypaka.betterareas.GUIs.SpawnLists.PossibleSpawnsList;
...
public class PossibleSpawnsMenu {
    ...
    public void build() {
        ...
        for (Area a : this.areas) {
            ...
            AreaSpawns spawns = AreaHandler.areaSpawnMap.get(a);
    ...
    public void open() throws ObjectMappingException {
        ...
        for (Map.Entry<String, Map<String, String>> entry : ConfigGetters.possibleSpawnsMenuSlotsMap.entrySet()) {
            ...
            if (entry.getKey().contains("Slot-")) {
                ...
                if (data.containsKey("Lore")) {
                    ...
                    List<String> displayLore = BetterAreas.configManager.getConfigNode(2, "Spawns-Possible", "Slots", entry.getKey(), "Lore").getList(TypeToken.of(String.class));
        ...
        if (this.spawnsMap.size() >= usable) {
            ...
            Map<String, Map<String, String>> utilityMap = BetterAreas.configManager.getConfigNode(2, "Spawns-Possible", "Slots", "Utility").getValue(new TypeToken<Map<String, Map<String, String>>>() {});
