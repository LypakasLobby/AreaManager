...
import com.lypaka.betterareas.GUIs.SpawnLists.AllSpawnsList;
...
public class AllSpawnsMenu {
    ...
    public void open() throws ObjectMappingException {
        ...
        for (Map.Entry<String, Map<String, String>> entry : ConfigGetters.allSpawnsMenuSlotsMap.entrySet()) {
            ...
            if (entry.getKey().contains("Slot-")) {
                ...
                if (data.containsKey("Lore")) {
                    ...
                    List<String> displayLore = BetterAreas.configManager.getConfigNode(2, "Spawns-All", "Slots", entry.getKey(), "Lore").getList(TypeToken.of(String.class));
        ...
        if (this.spawnsMap.size() >= usable) {
            ...
            Map<String, Map<String, String>> utilityMap = BetterAreas.configManager.getConfigNode(2, "Spawns-All", "Slots", "Utility").getValue(new TypeToken<Map<String, Map<String, String>>>() {});
