package com.lypaka.betterareas.Utils;

import com.google.common.reflect.TypeToken;
import com.lypaka.betterareas.BetterAreas;
import com.lypaka.betterareas.Utils.ExternalAbilities.CompoundEyes;
import com.lypaka.betterareas.Utils.ExternalAbilities.SuperLuck;
...
public class HeldItemUtils {
    ...
    public static void load() throws ObjectMappingException {
        ...
        heldItemMap = BetterAreas.configManager.getConfigNode(1, "Items").getValue(new TypeToken<Map<String, Map<String, List<String>>>>() {});
