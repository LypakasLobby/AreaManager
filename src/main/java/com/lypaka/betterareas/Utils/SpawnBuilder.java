...
public class SpawnBuilder {
    ...
    public static Pokemon buildRockSmashSpawn (String time, String weather, String rockType, AreaSpawns spawns) {
            ...
            if (stoneTypes.equalsIgnoreCase("Any")) {
                ...
                if (stoneTypes.contains(", ")) {
                    ...
                    for (String s : split) {
                        ...
                        if (s.equalsIgnoreCase(rockType)) {
                    ...
                    if (stoneTypes.equalsIgnoreCase(rockType)) {
