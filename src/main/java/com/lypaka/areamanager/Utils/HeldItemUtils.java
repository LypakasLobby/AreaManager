package com.lypaka.areamanager.Utils;

import com.google.common.reflect.TypeToken;
import com.lypaka.areamanager.AreaManager;
import com.lypaka.areamanager.Utils.ExternalAbilities.CompoundEyes;
import com.lypaka.areamanager.Utils.ExternalAbilities.SuperLuck;
...
public class HeldItemUtils {
    ...
    public static void load() throws ObjectMappingException {
        ...
        heldItemMap = AreaManager.configManager.getConfigNode(1, "Items").getValue(new TypeToken<Map<String, Map<String, List<String>>>>() {});
