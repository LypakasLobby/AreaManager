package com.lypaka.areamanager.Spawners;

import com.lypaka.areamanager.API.AreaRockSmashSpawnEvent;
import com.lypaka.areamanager.Areas.Area;
import com.lypaka.areamanager.Areas.AreaHandler;
import com.lypaka.areamanager.Areas.Spawns.AreaSpawns;
import com.lypaka.areamanager.Areas.Spawns.PokemonSpawn;
import com.lypaka.areamanager.Utils.ExternalAbilities.*;
import com.lypaka.areamanager.Utils.HeldItemUtils;
import com.lypaka.areamanager.Utils.SpawnBuilder;
            ...
            if (event.getPokeBall() instanceof OccupiedPokeBallEntity) {
                ...
                if (blockMaterial == Material.ROCK) {
                    ...
                    for (int i = 0; i < areas.size(); i++) {
                        ...
                        if (currentArea.getRockSmashSpawnerSettings().doesUsePixelmonsSystem()) continue;
                        if (currentArea.getRockSmashSpawnerSettings().getCooldown() > 0) {
                            ...
                            String timeExpires = now.plusSeconds(currentArea.getRockSmashSpawnerSettings().getCooldown()).toString();
                            toSendOut.getPersistentData().putString("RockSmashCooldown", timeExpires);

                        }
                        if (currentArea.getRockSmashSpawnerSettings().doesRequireMove()) {
                                    ...
                                    if (!spawnEvent.isCanceled()) {
                                        ...
                                        if (spawnEvent.getToSpawn() != null) {
                                            ...
                                            if (currentArea.getRockSmashSpawnerSettings().doesRequireMove()) {
                                                ...
                                                if (currentArea.getRockSmashSpawnerSettings().doesReducePP()) {
                                            ...
                                            if (currentArea.getRockSmashSpawnerSettings().getAutoBattleChance() > 0) {

                                                if (RandomHelper.getRandomChance(currentArea.getRockSmashSpawnerSettings().getAutoBattleChance())) {
                                            ...
                                            if (currentArea.getRockSmashSpawnerSettings().doesDespawnAfterBattle()) {
                                                ...
                                                if (currentArea.getRockSmashSpawnerSettings().getDespawnTimer() > 0) {

                                                    pixelmon.despawnCounter = currentArea.getRockSmashSpawnerSettings().getDespawnTimer();

                                                }

                                            }
                                            if (currentArea.getRockSmashSpawnerSettings().doesClearSpawns()) {
                ...
                if (event.getPokeBall() instanceof OccupiedPokeBallEntity) {
                    ...
                    if (hitEntity instanceof StatueEntity) {
                        ...
                        for (int i = 0; i < areas.size(); i++) {
                            ...
                            Area currentArea = areas.get(i);
                            if (currentArea.getRockSmashSpawnerSettings().doesUsePixelmonsSystem()) continue;
                            if (!currentArea.getRockSmashSpawnerSettings().getCustomRockSmashRockIDs().contains(entityID)) continue;
                            if (currentArea.getRockSmashSpawnerSettings().getCooldown() > 0) {
