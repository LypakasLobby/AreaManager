...
import com.lypaka.areamanager.API.AreaFishSpawnEvent;
                            ...
                            if (!spawnEvent.isCanceled()) {
                                ...
                                if (spawnEvent.getPokemon() != null) {
                                    ...
                                    if (currentArea.getFishSpawnerSettings().doesDespawnAfterBattle()) {
                                        ...
                                        if (currentArea.getFishSpawnerSettings().getDespawnTimer() > 0) {

                                            fishedUpPokemon.despawnCounter = currentArea.getFishSpawnerSettings().getDespawnTimer();

                                        }

                                    }
                                    if (currentArea.getFishSpawnerSettings().doesClearSpawns()) {
